...
public class SQLiteConnection {
    ...
    private static String buildDatabaseUrl() {
        Path repoRootStylePath = Path.of("LAB_5", "mydatabase.db");
        Path localLabPath = Path.of("mydatabase.db");

        // Support running from repo root and from inside LAB_5.
        Path selectedPath = Files.isDirectory(Path.of("LAB_5")) ? repoRootStylePath : localLabPath;
